...
public class addtomyorder extends WebDrivercommonlib {
    ...
    public static void main(String[] args) throws InterruptedException{
        ...
        Thread.sleep(5000);
        WebElement Next3 = driver.findElement(By.xpath("/html/body/html/body/div[4]/div[3]/div/div/div/c-rlmc-release/c-rlmc-allocation/div/c-rlmc-order-preference/div/section/div/div/div[2]/div[4]/div/div/div/button[2]"));
        Action.performClick(driver, Next3);
        Thread.sleep(6000);
        JavascriptExecutor js8 = (JavascriptExecutor) driver;
        js8.executeScript("window.scrollBy(0,1700)");
        Thread.sleep(3000);
        WebElement completeorder1 = driver.findElement(By.xpath("/html/body/html/body/div[4]/div[3]/div/div/div/c-rlmc-existing-order-checkout/div/section/div[1]/div/div[3]/div[3]/div/div[5]/div[2]/a"));
        Action.performClick(driver, completeorder1);
        driver.quit();
